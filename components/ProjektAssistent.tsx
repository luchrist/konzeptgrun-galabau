      ...
      {step === 0 ? (
        <div>
          <p className="text-[15px] leading-relaxed text-ink/70">
            Worum geht es? Mehrfachauswahl ist möglich. Teich, Pool oder Mauerarbeiten tragen Sie bitte
            unter Sonstiges ein, das bauen wir ebenfalls.
          </p>
          ...
          <div className="mt-4">
            ...
            <input
              ...
              placeholder="z.B. Teichbau, Poolumfeld, Mauerarbeiten"
